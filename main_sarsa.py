    ...
    if mode == "sarsa":
        while current_batch < n_batches:
            ...
            while episode_time < max_episode and episode_done == 0:
                    ...
                    nextAct = controller.epsilon_greedy(controller.Q, allowed_reformat, q_rows.index(nextState), current_total_steps = time, eps_type= "linear")
...
main_game(n_tables = (2, 3, 4), n_groups = (2, 3, 4), mode="sarsa", episodes = 200, alpha = 0.7, gamma = 0.3)
